...
public class StudyPrinter {
    ...
    public void print() throws IOException {
        try (FileWriter fileWriter = new FileWriter("participants.md");
            ...
            participantList.sort(Comparator.comparing(me.whiteship.refactoring._04_long_parameter_list._16_combine_functinos_into_class.Participant::username));

            writer.print(header(participantList.size()));
